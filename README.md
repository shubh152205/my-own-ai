# My Own Ai — Build a Vector Database from Scratch in C++
...
```powershell
git clone https://github.com/shubh152205/My_Own_Ai.git
cd My_Own_Ai
```

*(Replace `shubh152205` with the actual GitHub username)*

---

### Step 5 — Compile the C++ Server

Inside the `My_Own_Ai` folder, run:
...
**Terminal 2** — Start the My Own Ai server:
```powershell
./db
```
